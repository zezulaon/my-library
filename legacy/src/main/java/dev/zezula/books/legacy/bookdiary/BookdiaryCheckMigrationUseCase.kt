...
class BookdiaryCheckMigrationUseCase(
    ...
    private val migrationConfigDataProvider: MigrationConfigDataProvider,
        ...
        return asResponse {
            ...
            networkDataSource.updateMigrationData(
                NetworkMigrationData(
                    ...
                    legacyAppId = migrationConfigDataProvider.getApplicationId(),
                    migrationError = errorMessage,
                    versionCode = migrationConfigDataProvider.getVersionCode(),
